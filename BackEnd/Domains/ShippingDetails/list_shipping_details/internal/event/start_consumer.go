...
import (
	"list_shipping_details/config/kafka"
	message "list_shipping_details/internal/data/messages"
	dbcontext "list_shipping_details/internal/repository"
	"list_shipping_details/internal/secrets"
	"encoding/json"
	"fmt"
	"log"
	"os"
